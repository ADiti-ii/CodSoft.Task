...
mainframe=Frame(root,width=45,bd=12,relief=RIDGE,bg="red")
mainframe.pack()

inner=Frame(mainframe,width=45,bd=12,relief=RIDGE,bg="black")
inner.pack()
...
button_clear=Button(inner,text='C',padx=30,pady=10,relief=RIDGE,font=15,width=4,command=equal)
